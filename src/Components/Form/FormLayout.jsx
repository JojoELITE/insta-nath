        ...
        <div className="w-full max-w-[450px] flex flex-col gap-4">
            <div className="shadow border rounded-sm p-5">
                <div className="flex justify-center mb-3">
                    <img className="h-[60px] animate-spin" src="/asset/logo.png" alt="logo insta" />
                </div>
                {children}
                ...
                <button onClick={googleSignIn} className="py-2 w-full hover:shadow-lg rounded transition-all duration-500 mt-4 flex justify-center items-center gap-3">
                    <img className="h-[60px] " src="/asset/logo_1.png" alt="logo insta" />
                    <span>
                        Utiliser Google</span>
                </button>
            </div>
            <div className="shadow border rounded-sm p-5 flex justify-center items-center">
                <button onClick={change}>
                    {!status ?
                        <>J'ai déjà un compte , <span className="text-blue-500">Je me connecte</span></>
                        :
                        <>Vous n'avez pas de compte ? <span className="text-blue-500">Créer un compte</span></>}
